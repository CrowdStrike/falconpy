...
class TestFlightControl:
    def serviceFlight_GenerateErrors(self):
        ...
        tests = {
            ...
            "getCIDGroupMembersBy": falcon.get_cid_group_members_by(cid_group_ids='12345678'),
            "addCIDGroupMembers": falcon.add_cid_group_members(cid_group_id="12345678"),
            "deleteCIDGroupMembers": falcon.delete_cid_group_members(cid_group_id="12345678"),
            "getCIDGroupById": falcon.get_cid_group_by_id(cid_group_ids='12345678'),
            ...
            "getUserGroupMembersByID": falcon.get_user_group_members_by_id(user_group_ids='12345678'),
            "getUserGroupsByID": falcon.get_user_groups_by_id(user_group_ids='12345678'),
            ...
            "updateUserGroups": falcon.update_user_groups(user_group_id="12345678", name="UnitTesting"),
