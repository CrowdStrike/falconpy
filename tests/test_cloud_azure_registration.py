...
class TestCloudAzureRegistration:
    def test_all_code_paths(self):
        ...
        tests = {
            ...
            "cloud_registration_azure_create_suppressions": falcon.cloud_registration_azure_create_suppressions(resources="string"),
            "cloud_registration_azure_delete_suppressions": falcon.cloud_registration_azure_delete_suppressions(),
            "cloud_registration_azure_get_issue_suppression_values_by_field": falcon.cloud_registration_azure_get_issue_suppression_values_by_field(registration_id="string",
                field="string"),
            "cloud_registration_azure_get_issue_values_by_field": falcon.cloud_registration_azure_get_issue_values_by_field(registration_id="string",
                filter="string",
                field="string"),
            "cloud_registration_azure_get_issues": falcon.cloud_registration_azure_get_issues(registration_id="string",
                filter="string", sort="string",
                group_by="string", limit=1,
                offset=1),
            "cloud_registration_azure_get_script": falcon.cloud_registration_azure_get_script(tenant_id="string"),
            "cloud_registration_azure_get_script_versions": falcon.cloud_registration_azure_get_script_versions(deployment_method="string",
                sort="string",
                limit=1,
                offset=1),
            "cloud_registration_azure_get_suppressions": falcon.cloud_registration_azure_get_suppressions(registration_id="string",
                filter="string",
                sort="string",
                limit=1, offset=1),
            "cloud_registration_azure_update_suppressions": falcon.cloud_registration_azure_update_suppressions(resources="string"),
        }
        for key in tests:
