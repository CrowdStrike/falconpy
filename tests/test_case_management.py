    ...
    def test_all_code_paths(self):
        ...
        tests = {
            ...
            "entities_notification_groups_post_v1": falcon.create_notification_group(name="whatever",
                                                                                     ...
                                                                                     channels={"config_id": "123", "type": "email"}
                                                                                     ),
            "entities_notification_groups_patch_v1": falcon.update_notification_group(id="1234567",
                                                                                      name="whatever",
                                                                                      description="whatever",
                                                                                      channels=[{"config_id": "123", "type": "email"}]
                                                                                      ),
            ...
            "entities_slas_patch_v1": falcon.update_sla(description="whatever",
                                                        name="whatever",
                                                        goals={"duration_seconds": 0,
                                                               "type": "whatever",
                                                               "escalation_policy": {"steps":[{"escalate_after_seconds": 0, 
                                                                                               "notification_group_id": "1234567"}]}}
                                                        ),
            ...
            "entities_templates_post_v1": falcon.create_template(description="whatever",
                                                                 name="whatever",
                                                                 sla_id="1234567890",
                                                                 fields={"name": "whatever", "data_type": "whatever"}
                                                                 ),
            "entities_templates_patch_v1": falcon.update_template(id="1234567",
                                                                  name="whatever",
                                                                  sla_id="1234567890",
                                                                  description="whatever",
            ...
            "entities_cases_put_v2": falcon.create_case(name="whatever",
                                                        description="whatever",
                                                        assigned_to_user_uuid="whatever",
                                                        evidence={},
                                                        severity=0,
                                                        status="whatever",
                                                        tags=["whatever"],
