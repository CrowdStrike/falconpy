...
class TestFalconSensorUpdate:
    def serviceSensorUpdate_querySensorUpdatePolicies(self):
        if falcon.querySensorUpdatePolicies(parameters={"limit":1})["status_code"] == 200:
            return True
        else:
            return False

    def serviceSensorUpdate_querySensorUpdatePolicyMembers(self):
        if falcon.querySensorUpdatePolicyMembers(parameters={"limit":1})["status_code"] == 200:
            return True
        else:
            return False

    def serviceSensorUpdate_getSensorUpdatePolicies(self):
        if falcon.getSensorUpdatePolicies(ids=falcon.querySensorUpdatePolicies(parameters={"limit":1})["body"]["resources"][0])["status_code"] == 200:
            return True
        else:
            return False

    def serviceSensorUpdate_getSensorUpdatePoliciesV2(self):
        if falcon.getSensorUpdatePoliciesV2(ids=falcon.querySensorUpdatePolicies(parameters={"limit":1})["body"]["resources"][0])["status_code"] == 200:
            return True
        else:
            return False

    def serviceSensorUpdate_queryCombinedSensorUpdatePolicies(self):
        if falcon.queryCombinedSensorUpdatePolicies(parameters={"limit":1})["status_code"] == 200:
            return True
        else:
            return False

    def serviceSensorUpdate_queryCombinedSensorUpdatePolicyMembers(self):
        if falcon.queryCombinedSensorUpdatePolicyMembers(parameters={"limit":1})["status_code"] == 200:
            return True
        else:
            return False
