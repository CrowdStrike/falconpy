"""Internal payload handling library - NetworkScanGlobalConfigs.
...
def network_scan_global_configs_payload(passed_keywords: dict) -> Dict[str, Union[int, bool, dict, list]]:
