"""Internal payload handling library - NetworkScanDetections.
...
def aggregate_netscan_detections_payload(passed_keywords: dict) -> dict:
    """Create a properly formatted payload for a aggregate_detections request.
