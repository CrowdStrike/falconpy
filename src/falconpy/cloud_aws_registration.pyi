...
class CloudAWSRegistration(ServiceClass):
    ...
    def create_account(
        ...
        *,
        ...
        dspm_regions: Optional[list] = None,
        dspm_role: Optional[str] = None,
        dspm_service_permissions_override: Optional[list] = None,
        falcon_client_id: Optional[str] = None,
        iam_role_arn: Optional[str] = None,
        ioa_regions: Optional[list] = None,
        ...
        vulnerability_scanning_regions: Optional[list] = None,
