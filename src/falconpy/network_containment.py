...
class NetworkContainment(ServiceClass):
    ...
    def get_allowlist_rules(self: object,
        ...
        Swagger URL
        -----------
        https://assets.falcon.crowdstrike.com/support/api/swagger.html#/network-containment/GetContainmentAllowlistRules
    ...
    def create_allowlist_rules(self: object,
        ...
        Swagger URL
        -----------
        https://assets.falcon.crowdstrike.com/support/api/swagger.html#/network-containment/CreateContainmentAllowlistRules
    ...
    def delete_allowlist_rules(self: object,
        ...
        Swagger URL
        -----------
        https://assets.falcon.crowdstrike.com/support/api/swagger.html#/network-containment/DeleteContainmentAllowlistRules
    ...
    def update_allowlist_rules(self: object,
        ...
        Swagger URL
        -----------
        https://assets.falcon.crowdstrike.com/support/api/swagger.html#/network-containment/UpdateContainmentAllowlistRules
    ...
    def query_allowlist_rules(self: object,
        ...
        Swagger URL
        -----------
        https://assets.falcon.crowdstrike.com/support/api/swagger.html#/network-containment/QueryContainmentAllowlistRules
