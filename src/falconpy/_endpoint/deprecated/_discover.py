...
_discover_endpoints = [
  ...
  [
    "query-active-discovery-networks",
    "GET",
    ...
    [
      {
        ...
        "On your first request, don’t provide an `offset`. On subsequent requests, add previous `offset` with the "
        "previous `limit` to continue from that place in the results.",
        "name": "offset",
        "in": "query"
      },
      {
  ...
  [
    "query-active-discovery-scanners",
    "GET",
