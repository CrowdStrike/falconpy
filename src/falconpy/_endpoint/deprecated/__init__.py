...
_cloud_connect_aws_deprecated = _cloud_connect_aws_endpoints
...
_spotlight_vulnerability_metadata_deprecated = _spotlight_vulnerability_metadata_endpoints
_tailored_intelligence_deprecated = _tailored_intelligence_endpoints
