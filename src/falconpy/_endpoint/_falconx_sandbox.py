  ...
  [
    ...
    [
      ...
      },
      {
        ...
        "MacOS Tahoe ARM  400: MacOS Catalina 10.15 - deprecated, will fallback to MacOS Tahoe ARM  330: Linux Ubuntu "
        "24, 64-bit  310: Linux Ubuntu 20, 64-bit - deprecated, will fallback to Linux Ubuntu 24  200: Android (static "
        "analysis)  160: Windows 10, 64-bit  140: Windows 11, 64-bit  110: Windows 7, 64-bit  100: Windows 7, "
        "32-bit\n\n**sha256** ID of the sample, which is a SHA256 hash value. Find a sample ID from the response when "
        "uploading a malware sample or search with /falconx/queries/submissions/v1.The url parameter must be unset if "
        "sha256 is used.\n\n**url** A web page or file URL. It can be HTTP(S) or FTP. The sha256 parameter must be "
        "unset if url is used.\n\n**action_script** (optional): Runtime script for sandbox analysis. Values:\n  default "
        "  default_maxantievasion  default_randomfiles  default_randomtheme  default_openie\n\n**command_line** "
        ...
        "analysis\n\n**system_date** (optional): Set a custom date in the format yyyy-MM-dd for the sandbox "
        "environment\n\n**system_time** (optional): Set a custom time in the format HH:mm for the sandbox "
        "environment.",
        "name": "body",
        "in": "body",
        "required": True
