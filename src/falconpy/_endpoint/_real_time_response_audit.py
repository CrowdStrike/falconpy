  ...
  [
    ...
    [
      ...
      },
      {
        ...
        "type": "string",
        "description": "how to sort the session IDs. e.g. sort=created_at|desc "
        "will sort the results based on createdAt in descending order",
        "name": "sort",
        "in": "query"
      },
      {
      ...
      },
      {
        "type": "boolean",
        "default": False,
        "description": "get sessions with command info included; by default sessions "
        "are returned without command info which include cloud_request_ids and logs fields",
