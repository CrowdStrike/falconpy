  ...
  [
    ...
    [
      ...
      },
      {
        ...
        "static_host_groups, status, source_cid, migration_id, created_time, host_migration_id, groups, hostgroups, "
        "hostname, target_cid, id",
        "name": "filter",
        "in": "query"
      }
    ]
  ...
  [
    ...
    [
      ...
      },
      {
        ...
        "migration_id, target_cid, status, migration_status, created_by, created_time, name",
        "name": "filter",
        "in": "query"
      }
    ]
