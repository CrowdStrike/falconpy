...
_cloud_security_assets_endpoints = [
  [
    ...
    [
      ...
      {
        "type": "string",
        "description": "Sort expression in the format field|direction (e.g. key|desc), where direction is asc "
        "or desc. Sortable fields depend on the finding type. Currently supported for packages: 'key' (package name and "
        "version) and 'vulnerabilities' (number of vulnerabilities).",
        "name": "sort",
        "in": "query"
      }
    ]
