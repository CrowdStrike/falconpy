...
_agent_versions_endpoints = [
  [
    "GetAgentVersionsV1",
    "GET",
    "/agentic-studio/entities/agent-versions/v1",
  ...
  [
    ...
    "GET",
    "/agentic-studio/queries/agent-versions/v1",
    ...
    [
      ...
      {
        "type": "string",
        "description": "Possible order by fields: created_at. Ex: 'created_at|desc'.",
        "name": "sort",
        "in": "query"
      },
      {
