  ...
  [
    ...
    [
      ...
      },
      {
        ...
        "versioning_scheme, groups, is_normalized, last_used_user_sid, "
        "last_used_user_name,\n\t\t\t\tlast_used_file_name, last_used_file_hash, last_used_timestamp, "
        "last_updated_timestamp, is_suspicious, category, host.id, host.platform_name, host.hostname, cid, "
        "host.os_version, host.machine_domain, host.ou, host.site_name,\n\t\t\t\thost.country, "
        ...
        "last_used_file_name, last_used_file_hash,\n\t\t\t\thost.platform_name, host.hostname, cid, host.os_version, "
