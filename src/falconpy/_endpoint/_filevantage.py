  ...
  [
    ...
    [
      ...
      },
      {
        ...
        "collectionFormat": "multi",
        "description": "One or more rule group ids in the form of ids=ID1&ids=ID2. Note, for the precedence action, "
        "precedence is controlled by the order of the ids as they are specified in the request.",
        "name": "ids",
        "in": "query",
        "required": True
      }
    ...
    [
      {
        ...
        "of `true` or `false`.\n\n Rule and host group assignment and policy precedence setting is performed via "
        "their respective patch end-points.",
        "name": "body",
        "in": "body",
        "required": True
      }
    ...
    [
      {
        ...
        "can be between 0 and 500 characters.\n\n * `users` can be between 0 and 500 characters representing a comma "
        "separated list of user to exclude their changes.\n\n    *  admin* excludes changes made by all usernames that "
        "begin with admin. Falon GLOB syntax is supported.\n\n * `processes` can be between 0 and 500 characters "
        "representing a comma separated list of processes to exclude their changes.\n\n    * **\\RunMe.exe or **/RunMe.sh "
        "excludes changes made by RunMe.exe or RunMe.sh in any location.\n\n * `schedule_start` must be provided to "
        "indicate the start of the schedule. This date/time must be an rfc3339 formatted string "
        "https://datatracker.ietf.org/doc/html/rfc3339.\n\n * `schedule_end` optionally provided to indicate "
        "the end of the schedule. This date/time must be an rfc3339 formatted string "
        "https://datatracker.ietf.org/doc/html/rfc3339.",
        "name": "body",
        "in": "body",
        "required": True
    ...
    [
      {
        ...
        "representing the scheduled exclusion to update.\n\n * `policy_id` which the scheduled exclusion "
        "is assigned.\n\n * `name` must be between 1 and 100 characters.\n\n * `description` can be between "
        "0 and 500 characters.\n\n * `users` can be between 0 and 500 characters representing a comma "
        "separated list of user to exclude their changes.\n\n    *  admin* excludes changes made by all "
        "usernames that begin with admin. Falon GLOB syntax is supported.\n\n * `processes` can be between "
        "0 and 500 characters representing a comma separated list of processes to exclude their changes.\n\n"
        "    * **\\RunMe.exe or **/RunMe.sh excludes changes made by RunMe.exe or RunMe.sh in any location."
        "\n\n * `schedule_start` must be provided to indicate the start of the schedule. This date/time must "
        "be an rfc3339 formatted string  https://datatracker.ietf.org/doc/html/rfc3339.\n\n * `schedule_end` "
        "optionally provided to indicate the end of the schedule. This date/time must be an rfc3339 formatted "
        "string  https://datatracker.ietf.org/doc/html/rfc3339.",
        "name": "body",
        "in": "body",
        "required": True
      }
    ...
    [
      {
        ...
        "be between 1 and 250 characters. \n\n   * All paths must end with the path separator, e.g. "
        ...
        "must be one of: `1`, `2`, `3`, `4`, `5` or `ANY`\n\n * `precedence` - is not supported for creation "
        "of a rule, new rules will be added last in precedence order.will result this rule being placed before "
        ...
        "represents the files, directories, registry keys, or registry values that will be monitored. \n\n "
        "* `exclude` represents the files, directories, registry keys, or registry values that will `NOT` "
        "be monitored. \n\n * `include_users` represents the changes performed by specific users that will "
        "be monitored (`macOS` is not supported at this time).\n\n * `exclude_users` represents the changes "
        "performed by specific users that will `NOT` be monitored (`macOS` is not supported at this time)."
        ...
        "specific processes that will be `NOT` monitored (`macOS` is not supported at this time).\n\nFile "
    ...
    [
      {
        ...
        "\n\n * `id` of the rule to update.\n\n * `rule_group_id` that contains the rule "
        "configuration.\n\n * `description` can be between 0 and 500 characters.\n\n * "
        "`path` representing the file system or registry path to monitor.\n\n   * must be "
        "between 1 and 250 characters. \n\n   * All paths must end with the path separator, "
        "e.g. c:\\windows\\ /usr/bin/ \n\n * `severity` to categorize change events produced "
        "by this rule; must be one of: `Low`, `Medium`, `High` or `Critical`\n\n * `depth` "
        "below the base path to monitor; must be one of: `1`, `2`, `3`, `4`, `5` or `ANY`"
        "\n\n * `precedence` is the order in which rules will be evaluated starting with 1. "
        "Specifying a precedence value that is already set for another rule in the group will "
        "result this rule being placed before that existing rule.\n\nFalcon GLOB syntax is "
        "supported for the following 6 properties. Allowed rule group configuration is based "
        "on the type of rule group the rule group is added to.\n\n * `include` represents the "
        "files, directories, registry keys, or registry values that will be monitored. \n\n "
        "* `exclude` represents the files, directories, registry keys, or registry values "
        "that will `NOT` be monitored. \n\n * `include_users` represents the changes performed "
        "by specific users that will be monitored (`macOS` is not supported at this time).\n\n "
        "* `exclude_users` represents the changes performed by specific users that will `NOT` "
        "be monitored (`macOS` is not supported at this time).\n\n * `include_processes` "
        "represents the changes performed by specific processes that will be monitored "
        "(`macOS` is not supported at this time).\n\n * `exclude_users` represents the changes "
        "performed by specific processes that will be `NOT` monitored (`macOS` is not supported "
    ...
    [
      {
        ...
        "100 characters.\n\n * `type` must be one of `WindowsFiles`, `WindowsRegistry`, `LinuxFiles` or "
        "`MacFiles`.\n\n * `description` can be between 0 and 500 characters.\n\n Note: rules are "
    ...
    [
      {
        ...
        "of the rule group to update.\n\n * `name` must be between 1 and 100 characters.\n\n * "
        "`description` can be between 0 and 500 characters.\n\n * `type` may not be modified after "
  ...
  [
    ...
    [
      ...
      },
      {
        ...
        "`created_timestamp` or `modified_timestamp`\n\n Sort either `asc` (ascending) or `desc` "
        "(descending);  for example: `precedence|asc`.",
        "name": "sort",
        "in": "query"
      },
      {
  ...
  [
    ...
    [
      ...
      },
      {
        ...
        "for example: `created_timestamp|asc`.",
        "name": "sort",
        "in": "query"
      },
      {
        ...
        "`WindowsFiles`, `WindowsRegistry`, `LinuxFiles` or `MacFiles`.",
        "name": "type",
        "in": "query",
        "required": True
      }
