...
_network_scan_zones_endpoints = [
  [
    "aggregate_zones",
    "POST",
    "/netscan/aggregates/zones/GET/v1",
  ...
  [
    ...
    [
      ...
      {
        "type": "string",
        "description": "Sort \"zones\" by their properties. A single sort field is allowed",
        "name": "sort",
        "in": "query"
      },
      {
        "type": "string",
        "description": "Search for \"zones\" by providing an FQL filter",
        "name": "filter",
        "in": "query"
      }
    ]
    ...
    [
      {
        ...
        "description": "IDs of \"zones\" to be retrieved (Min: 1, Max: 100)",
        "name": "ids",
        "in": "query",
        "required": True
      }
  ...
  [
    ...
    [
      {
        "description": "\"zones\" specifications",
        "name": "body",
        "in": "body",
        "required": True
      }
    ...
    [
      {
        ...
        "collectionFormat": "multi",
        "description": "IDs of \"zones\" to be deleted (Min: 1, Max: 100)",
        "name": "ids",
        "in": "query",
        "required": True
      }
