"""CrowdStrike Falcon CloudSecurityRisks API interface class.
...
from ._endpoint._cloud_security_risks import _cloud_security_risks_endpoints as Endpoints
...
class CloudSecurityRisks(ServiceClass):
    ...
    def cloud_security_timeline_risks_enriched(self: object,
                                               *args,
        ...
        return process_service_request(
            calling_object=self,
            endpoints=Endpoints,
            operation_id="cloud_security_timeline_risks_enriched",
            keywords=kwargs,
