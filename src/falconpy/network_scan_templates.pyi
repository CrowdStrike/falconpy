...
class NetworkScanTemplates(ServiceClass):
    ...
    def create_templates(
        ...
        *,
        ...
        additional_tcp_ports: Optional[list] = None,
        additional_udp_ports: Optional[list] = None,
        auto_include_new_detections: Optional[bool] = None,
        detections: Optional[list] = None,
        excluded_tcp_ports: Optional[list] = None,
        excluded_udp_ports: Optional[list] = None,
