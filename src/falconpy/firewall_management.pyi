...
class FirewallManagement(ServiceClass):
    ...
    def update_network_locations_metadata(
        ...
        *,
        ...
        location_precedence: Optional[list] = None,
    ...
    def create_network_locations(
        ...
        *,
        ...
        default_gateways: Optional[list] = None,
        description: Optional[str] = None,
        dhcp_servers: Optional[list] = None,
        dns_resolution_targets: Optional[dict] = None,
        dns_servers: Optional[list] = None,
        enabled: Optional[bool] = None,
        host_addresses: Optional[list] = None,
    ...
    def update_policy_container_v1(
        ...
        *,
        ...
        rule_group_ids: Optional[list] = None,
