"""CrowdStrike Falcon MaintenanceToken API interface class.
...
from ._payload import maintenance_token_payload
from ._result import Result
from ._service_class import ServiceClass
from ._endpoint._maintenance_token import _maintenance_token_endpoints as Endpoints


class MaintenanceToken(ServiceClass):
