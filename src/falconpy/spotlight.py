"""CrowdStrike Falcon Spotlight API interface class.
...
class Spotlight(SpotlightVulnerabilities,  # pylint: disable=too-many-ancestors
                SpotlightVulnerabilityMetadata,
                SpotlightEvaluationLogic):
    """Combined Spotlight service collection providing access to all spotlight operations.

    This class aggregates all Spotlight sub-service collections into a single interface
