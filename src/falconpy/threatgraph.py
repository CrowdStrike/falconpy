...
class ThreatGraph(ServiceClass):
    ...
    def get_edges(self: object, parameters: dict = None, **kwargs) -> Union[Dict[str, Union[int, dict]], Result]:
        ...
        edge_type : str
            The type of edges that you would like to retrieve. String.
            Available values:
            ...
            agent_to_self_diagnostic                              agentic_root_process
            ...
            classified_file_accessed_by                           closed_ip4_socket
            ...
            detected_module                                       detected_nonexec_written
            detection                                             device
            ...
            network_listen_ip6                                    nonexec_written_by_process
            ...
            process_ai_agent                                      process_ai_session
            ...
            spawns_agent                                          subagent_connected_mcp
            subagent_loaded_skill                                 subagent_used_tool
    ...
    def get_ran_on(self: object, parameters: dict = None, **kwargs) -> Union[Dict[str, Union[int, dict]], Result]:
        ...
        parameters : dict
            Full parameters payload. Not required if using other keywords.
        type : str
            The type of indicator that you would like to retrieve. String.
    ...
    def get_summary(self: object,
        ...
        parameters : dict
            Full parameters payload. Not required if using other keywords.
        vertex_type : str
            Type of vertex to get properties for. String.
            Allowed values:
            ...
            ai-subagents                   ai-tools
            ai_agent                       ai_model
            ai_prompt                      ai_session
            ai_skill                       ai_subagent
            ai_tool                        any-vertex
            ...
            modules                        nonexec_file
            nonexec_files                  okta-applications
