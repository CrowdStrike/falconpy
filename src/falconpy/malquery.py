...
class MalQuery(ServiceClass):
    ...
    def GetMalQueryQuotasV1(self: object) -> dict:
        ...
        target_url = f"{self.base_url}/malquery/aggregates/quotas/v1"
    ...
    def PostMalQueryFuzzySearchV1(self: object, body: dict) -> dict:
        ...
        target_url = f"{self.base_url}/malquery/combined/fuzzy-search/v1"
        header_payload = self.headers
        body_payload = body
        returned = service_request(caller=self,
                                   method="POST",
    ...
    def GetMalQueryDownloadV1(self: object, ids) -> dict:
        ...
        target_url = f"{self.base_url}/malquery/entities/download-files/v1?ids={id_list}"
        header_payload = self.headers
        returned = service_request(caller=self,
                                   method="GET",
                                   endpoint=target_url,
    ...
    def GetMalQueryMetadataV1(self: object, ids) -> dict:
        """Retrieve indexed files metadata by their hash"""
        # [GET] https://assets.falcon.crowdstrike.com/support/api/swagger.html#/malquery/GetMalQueryMetadataV1
        id_list = str(parse_id_list(ids)).replace(",", "&ids=")
        target_url = f"{self.base_url}/malquery/entities/metadata/v1?ids={id_list}"
        header_payload = self.headers
        returned = service_request(caller=self,
                                   method="GET",
                                   endpoint=target_url,
    ...
    def GetMalQueryRequestV1(self: object, ids) -> dict:
        ...
        id_list = str(parse_id_list(ids)).replace(",", "&ids=")
        target_url = f"{self.base_url}/malquery/entities/requests/v1?ids={id_list}"
        header_payload = self.headers
        returned = service_request(caller=self,
                                   method="GET",
                                   endpoint=target_url,
    ...
    def GetMalQueryEntitiesSamplesFetchV1(self: object, ids) -> dict:
        ...
        id_list = str(parse_id_list(ids)).replace(",", "&ids=")
        target_url = f"{self.base_url}/malquery/entities/samples-fetch/v1?ids={id_list}"
        header_payload = self.headers
        returned = service_request(caller=self,
                                   method="GET",
                                   endpoint=target_url,
    ...
    def PostMalQueryEntitiesSamplesMultidownloadV1(self: object, body: dict) -> dict:
        ...
        target_url = f"{self.base_url}/malquery/entities/samples-multidownload/v1"
        header_payload = self.headers
        body_payload = body
        returned = service_request(caller=self,
                                   method="POST",
    ...
    def PostMalQueryExactSearchV1(self: object, body: dict) -> dict:
        ...
        target_url = f"{self.base_url}/malquery/queries/exact-search/v1"
        header_payload = self.headers
        body_payload = body
        returned = service_request(caller=self,
                                   method="POST",
    ...
    def PostMalQueryHuntV1(self: object, body: dict) -> dict:
        ...
        target_url = f"{self.base_url}/malquery/queries/hunt/v1"
        header_payload = self.headers
        body_payload = body
        returned = service_request(caller=self,
                                   method="POST",
