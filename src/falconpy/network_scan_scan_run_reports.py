"""CrowdStrike Falcon NetworkScanScanRunReports API interface class.
...
from ._endpoint._network_scan_scan_run_reports import _network_scan_scan_run_reports_endpoints as Endpoints
...
class NetworkScanScanRunReports(ServiceClass):
    ...
    def get_scan_run_reports(self: object,
                             *args,
        ...
        return process_service_request(
            calling_object=self,
            endpoints=Endpoints,
            operation_id="get_scan_run_reports",
            keywords=kwargs,
