"""Falcon Overwatch Dashboard API Interface Class (Deprecated).
...
from ._endpoint.deprecated._overwatch_dashboard import _overwatch_dashboard_endpoints as Endpoints
