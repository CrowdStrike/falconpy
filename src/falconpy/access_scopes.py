"""CrowdStrike Falcon AccessScopes API interface class.
...
from ._endpoint._access_scopes import _access_scopes_endpoints as Endpoints
...
class AccessScopes(ServiceClass):
    ...
    def list_access_scopes_external(self: object,
                                    *args,
        ...
        return process_service_request(
            calling_object=self,
            endpoints=Endpoints,
            operation_id="ListAccessScopesExternal",
            keywords=kwargs,
            params=handle_single_argument(args, parameters, "ids")
            )

    @force_default(defaults=["parameters"], default_types=["dict"])
    def query_access_scopes_external(self: object,
                                     parameters: dict = None,
                                     **kwargs
                                     ) -> Union[Dict[str, Union[int, dict]], Result]:
        ...
        return process_service_request(
            calling_object=self,
            endpoints=Endpoints,
            operation_id="QueryAccessScopesExternal",
            keywords=kwargs,
            params=parameters
            )
