...
class NetworkScanDetections(ServiceClass):
    ...
    def aggregate_netscan_detections(self: object,
        ...
        Swagger URL
        -----------
        https://assets.falcon.crowdstrike.com/support/api/swagger.html#/network-scan-detections/aggregate-detections
    ...
    def get_combined_netscan_detections(self: object,
        ...
        Swagger URL
        -----------
        https://assets.falcon.crowdstrike.com/support/api/swagger.html#/network-scan-detections/combined-detections
    ...
    def get_netscan_detections(self: object,
        ...
        Swagger URL
        -----------
        https://assets.falcon.crowdstrike.com/support/api/swagger.html#/network-scan-detections/get-detections
    ...
    def query_netscan_detections(self: object,
        ...
        Swagger URL
        -----------
        https://assets.falcon.crowdstrike.com/support/api/swagger.html#/network-scan-detections/query-detections
