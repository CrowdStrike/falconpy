...
class D4CRegistration(ServiceClass):
    ...
    @force_default(defaults=["parameters"], default_types=["dict"])
    def get_azure_user_scripts_attachment(self: object, parameters: dict = None, **kwargs) -> dict:
    ...
    @force_default(defaults=["parameters"], default_types=["dict"])
    def get_gcp_user_scripts(self: object, *args, parameters: dict = None, **kwargs) -> dict:
