...
def scrub_target(oper: str, scrubbed: str, kwas: dict) -> str:
    ...
    field_mapping = {
        ...
        "GetSchema": ["collection_name", "schema_version"],
        "GetSchemaMetadata": ["collection_name", "schema_version"],
        ...
        "PutObjectByVersion": ["collection_name", "collection_version", "object_key"],
        ...
        "UpdateGroup": ["id"],
        "RetrieveRelayInstances": ["id"],
        "RunIntegrationTaskAdmin": ["id"],
        "RunIntegrationTaskV2": ["id"],
