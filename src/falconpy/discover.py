...
class Discover(ServiceClass):
    ...
    @force_default(defaults=["parameters"], default_types=["dict"])
    def query_active_networks(self: object, parameters: dict = None, **kwargs) -> dict:
        """Search for active discovery networks in your environment.
        ...
        Keyword arguments:
        filter -- The filter expression that should be used to limit the results. FQL syntax.
        limit -- The number of active network IDs to return in this response. (Max: 100, default: 100)
                 Use with the offset parameter to manage pagination of results.
        offset -- An offset used with the limit parameter to manage pagination of results.
                  On your first request, don’t provide an offset. On subsequent requests,
                  provide the offset from the previous response to continue from that place
                  in the results.
        parameters - full parameters payload, not required if using other keywords.
        sort -- Sort active networks by their properties. A single sort field is allowed.
        ...
        Swagger URL
        https://assets.falcon.crowdstrike.com/support/api/swagger.html#/discover/query-active-discovery-networks
        """
        return process_service_request(
            calling_object=self,
            endpoints=Endpoints,
            operation_id="query_active_discovery_networks",
            keywords=kwargs,
            params=parameters
            )

    @force_default(defaults=["parameters"], default_types=["dict"])
    def query_active_rules(self: object, parameters: dict = None, **kwargs) -> dict:
        """Search for active discovery rules in your environment.
        ...
        Keyword arguments:
        filter -- The filter expression that should be used to limit the results. FQL syntax.
        limit -- The number of active rule IDs to return in this response. (Max: 100, default: 100)
                 Use with the offset parameter to manage pagination of results.
        offset -- An offset used with the limit parameter to manage pagination of results.
                  On your first request, don’t provide an offset. On subsequent requests,
                  provide the offset from the previous response to continue from that place
                  in the results.
        parameters - full parameters payload, not required if using other keywords.
        sort -- Sort active rules by their properties. A single sort field is allowed.
        ...
        Swagger URL
        https://assets.falcon.crowdstrike.com/support/api/swagger.html#/discover/query-active-discovery-rules
        """
        return process_service_request(
            calling_object=self,
            endpoints=Endpoints,
            operation_id="query_active_discovery_rules",
            keywords=kwargs,
            params=parameters
            )

    @force_default(defaults=["parameters"], default_types=["dict"])
    def query_active_scanners(self: object, parameters: dict = None, **kwargs) -> dict:
        """Search for active discovery scanners in your environment.
        ...
        Keyword arguments:
        filter -- The filter expression that should be used to limit the results. FQL syntax.
        limit -- The number of active scanner IDs to return in this response. (Max: 100, default: 100)
                 Use with the offset parameter to manage pagination of results.
        offset -- An offset used with the limit parameter to manage pagination of results.
                  On your first request, don’t provide an offset. On subsequent requests,
                  provide the offset from the previous response to continue from that place
                  in the results.
        parameters - full parameters payload, not required if using other keywords.
        sort -- Sort active scanners by their properties. A single sort field is allowed.
        ...
        Swagger URL
        https://assets.falcon.crowdstrike.com/support/api/swagger.html#/discover/query-active-discovery-scanners
        """
        return process_service_request(
            calling_object=self,
            endpoints=Endpoints,
            operation_id="query_active_discovery_scanners",
            keywords=kwargs,
            params=parameters
            )

    @force_default(defaults=["parameters"], default_types=["dict"])
    def query_active_scans(self: object, parameters: dict = None, **kwargs) -> dict:
        """Search for active discovery scans in your environment.
        ...
        Keyword arguments:
        filter -- The filter expression that should be used to limit the results. FQL syntax.
        limit -- The number of active scan IDs to return in this response. (Max: 100, default: 100)
                 Use with the offset parameter to manage pagination of results.
        offset -- An offset used with the limit parameter to manage pagination of results.
                  On your first request, don’t provide an offset. On subsequent requests,
                  provide the offset from the previous response to continue from that place
                  in the results.
        parameters - full parameters payload, not required if using other keywords.
        sort -- Sort active scans by their properties. A single sort field is allowed.
        ...
        Swagger URL
        https://assets.falcon.crowdstrike.com/support/api/swagger.html#/discover/query-active-discovery-scans
        """
        return process_service_request(
            calling_object=self,
            endpoints=Endpoints,
            operation_id="query_active_discovery_scans",
            keywords=kwargs,
            params=parameters
            )
    ...
    # Operation ID aliases
    query_active_discovery_networks = query_active_networks
    query_active_discovery_rules = query_active_rules
    query_active_discovery_scanners = query_active_scanners
    query_active_discovery_scans = query_active_scans
