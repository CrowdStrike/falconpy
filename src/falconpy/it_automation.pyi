...
class ITAutomation(ServiceClass):
    ...
    def update_user_group(
        ...
        *,
        ...
        description: Optional[str] = None,
        name: Optional[str] = None,
        remove_user_ids: Optional[list] = None,
        body: Optional[dict] = None,
        parameters: Optional[dict] = None,
    ) -> Union[Dict[str, Union[int, dict]], Result]: ...
    ...
    def update_policy_host_groups(
        ...
        *,
        ...
        host_group_ids: Optional[list] = None,
    ...
    def create_task_group(
        ...
        *,
        ...
        assigned_user_group_ids: Optional[list] = None,
    ...
    def update_task_group(
        ...
        *,
        id: Optional[str] = None,
        access_type: Optional[str] = None,
        add_assigned_user_group_ids: Optional[list] = None,
        add_assigned_user_ids: Optional[list] = None,
        add_task_ids: Optional[list] = None,
        description: Optional[str] = None,
        name: Optional[str] = None,
        remove_assigned_user_group_ids: Optional[list] = None,
        remove_assigned_user_ids: Optional[list] = None,
        remove_task_ids: Optional[list] = None,
        body: Optional[dict] = None,
        parameters: Optional[dict] = None,
    ) -> Union[Dict[str, Union[int, dict]], Result]: ...
