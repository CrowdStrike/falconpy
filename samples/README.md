...
| [Vulnerability Management (Spotlight)](#vulnerability-management-samples) | Find vulnerable hosts by CVE ID<BR/>CISA DHS Known Exploited Vulnerabilities<BR/>Query installed patches<BR/>Spotlight Quick Report<BR/>Spotlight Vulnerability Dashboard |
