...
- rayheffer@CrowdStrike, 03.29.22 - Added new argument for Grouping Tags (--grouping, -g)
"""
...
def get_hosts(date_filter: str, tag_filter: str) -> list:
    """
    Retrieves a list of hosts IDs that match the last_seen date and grouping tag filter.
    """
