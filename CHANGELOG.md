...
+ Bug fix: Fixed typo in operation ID for query_platforms method within CustomIOA Service Class. `custom_ioa.py`
+ Bug fix: Fixed typo in operation ID for create_user_groups method within FlightControl Service Class. `mssp.py`
