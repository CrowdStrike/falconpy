...
| CrowdStrike Intel | [intel.py](https://github.com/CrowdStrike/falconpy/blob/main/src/falconpy/intel.py) | [Intel](https://www.falconpy.io/Service-Collections/Intel.html) |
...
| Falcon Discover for Cloud and Containers - AWS | [cloud_connect_aws.py](https://github.com/CrowdStrike/falconpy/blob/main/src/falconpy/cloud_connect_aws.py) | [CloudConnectAWS](https://www.falconpy.io/Service-Collections/Cloud-Connect-AWS.html) |
| Falcon Discover for Cloud and Containers - Azure, GCP | [d4c_registration.py](https://github.com/CrowdStrike/falconpy/blob/main/src/falconpy/d4c_registration.py) | [D4CRegistration](https://www.falconpy.io/Service-Collections/D4C-Registration.html) |
